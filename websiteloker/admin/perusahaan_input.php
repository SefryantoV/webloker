...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if ($foto_name) {
            ...
            $foto_name = "perusahaan_" . time() . "_" . $foto_name;
        ...
        if ($id != "") {
            $sql1 = "update perusahaan set nama = '$nama',foto = '$foto_name', isi = '$isi', tgl_isi=now() where id = '$id'";
        } else {
            $sql1 = "insert into perusahaan(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Perusahaan</h1>
<div class="mb-3 row">
    <a href="perusahaan.php">
        < Kembali ke Home perusahaan</a>
</div>
<?php
if ($error) {
?>
